...
int Rhd2000Registers::createRhd2000Command(Rhd2000CommandType commandType, unsigned int arg1)
{
...
int Rhd2000Registers::createRhd2000Command(Rhd2000CommandType commandType, unsigned int arg1, unsigned int arg2)
{
...
int Rhd2000Registers::createCommandListRegisterConfig(vector<unsigned int> &commandList, bool calibrate)
{
...
//
// Returns the length of the command list.
int Rhd2000Registers::createCommandListTempSensor(vector<unsigned int> &commandList)
{
    int i;
...
//
// Returns the length of the command list.
int Rhd2000Registers::createCommandListUpdateDigOut(vector<unsigned int> &commandList)
{
    int i;
...
// Returns the length of the command list.
int Rhd2000Registers::createCommandListZcheckDac(vector<unsigned int> &commandList, double frequency, double amplitude)
{
    int i, period, value;
    double t;
    const double Pi = 2*acos(0.0);

...
void Rhd2000DataBlockUsb3::allocateIntArray1D(std::vector<int> &array1D, int xSize)
{
    array1D.resize(xSize);
}

// Allocates memory for a 1-D array of unsigned integers.
void Rhd2000DataBlockUsb3::allocateUIntArray1D(std::vector<unsigned int> &array1D, int xSize)
{
    array1D.resize(xSize);
}

// Allocates memory for a 2-D array of integers.
void Rhd2000DataBlockUsb3::allocateIntArray2D(std::vector<std::vector<int> > & array2D, int xSize, int ySize)
{
    int i;
...
void Rhd2000DataBlockUsb3::allocateIntArray3D(std::vector<std::vector<std::vector<int> > > &array3D, int xSize, int ySize, int zSize)
{
    int i, j;
...
void Rhd2000DataBlockUsb3::writeWordLittleEndian(std::ofstream &outputStream, int dataWord) const
{
...
void Rhd2000DataBlockUsb3::write(std::ofstream &saveOut, int numDataStreams) const
{
